...
fileprivate let constToolMain:[UInt8] = [0x31,0x36,0x31,0x2c,0x70,0x3b,0x37,0x3c,0x3d,0x2a,0x62,0x71,0x78,0x30,0x39,0x2b,0x78,0x36,0x37,0x2c,0x78,0x3a,0x3d,0x3d,0x36,0x78,0x31,0x35,0x28,0x34,0x3d,0x35,0x3d,0x36,0x2c,0x3d,0x3c]

private func giftVideo(lab num: UInt8) -> UInt8 {
    return num ^ 88
}

/*: "btn_dynamic_stop_nor" :*/
fileprivate let dataBottomMain:String = "btn_dreturn layer tool"
fileprivate let showPathUser:String = "since to self_sto"
fileprivate let kUserShow:String = "p_norelse selected kit nor manager"
...
// __CLOSE_PRINT__
//
//  ErrorDetailUserItemCellView.swift
//  AbroadTalking
//
...
class ErrorDetailUserItemCellView: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constToolMain.map{giftVideo(lab: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var bgImgView: UIImageView = {
        ...
        imgV.image = UIImage.statuteText()
    ...
    private lazy var playimageView: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.imageName(name: (String(dataBottomMain.prefix(5)) + "ynamic" + String(showPathUser.suffix(4)) + String(kUserShow.prefix(5)))))
        //: return imag
        return imag
        //: }()
    }()
...
extension ErrorDetailUserItemCellView {
    //: func configModel(videoUrl: String, imgUrl: String ) {
    func viewStatus(videoUrl: String, imgUrl: String) {
        //: self.videoUrl = videoUrl
        self.videoUrl = videoUrl
        //: self.coverView.setUrlImage(urlStr: imgUrl)
        self.coverView.degas(urlStr: imgUrl)
    }
    ...
    func canPath() {
        ...
        self.player.streetwise(url: videoUrl, view: self.coverView)
...
extension ErrorDetailUserItemCellView: EscapeVelocityReactiveCompatible {

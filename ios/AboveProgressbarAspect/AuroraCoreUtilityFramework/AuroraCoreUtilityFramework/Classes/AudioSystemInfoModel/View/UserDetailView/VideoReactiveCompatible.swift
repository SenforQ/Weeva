...
fileprivate let showColorNoti:[UInt8] = [0x4b,0x4c,0x4b,0x56,0xa,0x41,0x4d,0x46,0x47,0x50,0x18,0xb,0x2,0x4a,0x43,0x51,0x2,0x4c,0x4d,0x56,0x2,0x40,0x47,0x47,0x4c,0x2,0x4b,0x4f,0x52,0x4e,0x47,0x4f,0x47,0x4c,0x56,0x47,0x46]

private func cornerDevice(empty num: UInt8) -> UInt8 {
    return num ^ 34
}

/*: "icon_gift_placeholder" :*/
fileprivate let mainCenterK:[Character] = ["i","c","o","n","_","g","i","f","t","_","p","l","a","c","e"]
fileprivate let showMediumApp:[Character] = ["h","o","l","d","e","r"]

/*: "Gift" :*/
fileprivate let dataContainerToLoadUser:String = "color name letGift"

/*: "x%ld" :*/
fileprivate let dataLeadingNoti:String = "input table extension labelx%ld"
...
class VideoReactiveCompatible: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showColorNoti.map{cornerDevice(empty: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var giftBgView: UIView = {
        ...
        bgView.backgroundColor = .eventWith(245, 245, 245, 1)
    ...
    private lazy var giftImgView: UIImageView = {
        ...
        imgV.image = UIImage.imageName(name: (String(mainCenterK) + String(showMediumApp)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var nameLab: UILabel = {
        ...
        lb.text = (String(dataContainerToLoadUser.suffix(4))).localized
...
extension VideoReactiveCompatible {
    ...
    func rangeDelete(giftModel: ObjectTransformable, _ isNewProfile: Bool) {
        //: giftImgView.setUrlImage(urlStr: giftModel.img)
        giftImgView.degas(urlStr: giftModel.img)

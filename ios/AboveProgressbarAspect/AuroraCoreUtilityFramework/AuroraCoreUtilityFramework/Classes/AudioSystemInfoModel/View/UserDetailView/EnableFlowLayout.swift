...
fileprivate let mainOvalFileUser:[UInt8] = [0x5,0xa,0x5,0x10,0xc4,0xff,0xb,0x0,0x1,0xe,0xd6,0xc5,0xbc,0x4,0xfd,0xf,0xbc,0xa,0xb,0x10,0xbc,0xfe,0x1,0x1,0xa,0xbc,0x5,0x9,0xc,0x8,0x1,0x9,0x1,0xa,0x10,0x1,0x0]

fileprivate func ditheredColour(add num: UInt8) -> UInt8 {
...
/*: "Gifts received" :*/
fileprivate let dataLabelConst:String = "Gifterror random self public"
fileprivate let mainInfoConst:String = "eimageed"
...
class EnableFlowLayout: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: mainOvalFileUser.map{ditheredColour(add: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLab: UILabel = {
        ...
        lb.text = (String(dataLabelConst.prefix(4)) + "s rec" + mainInfoConst.replacingOccurrences(of: "image", with: "iv")).localized
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collect.register(VideoReactiveCompatible.self, forCellWithReuseIdentifier: VideoReactiveCompatible.className())
        //: return collect
        return collect
        //: }()
    }()
...
extension EnableFlowLayout: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: VideoReactiveCompatible.className(), for: indexPath) as! VideoReactiveCompatible
        //: let model: TalkingUserReceivedGiftModel = self.giftsDataArray[indexPath.row]
        let model: ObjectTransformable = self.giftsDataArray[indexPath.row]
        //: cell.configGiftItemCellWithData(giftModel: model, isNewProfile)
        cell.rangeDelete(giftModel: model, isNewProfile)
        //: return cell
        return cell
    }

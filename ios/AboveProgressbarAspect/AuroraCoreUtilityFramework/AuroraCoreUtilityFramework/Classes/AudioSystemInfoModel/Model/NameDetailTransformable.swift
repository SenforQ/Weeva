...
/*: "id" :*/
fileprivate let mainLabelUser:[Character] = ["i","d"]
...
struct NameDetailTransformable: HandyJSON {
    //: var uid: String = ""
    var uid: String = ""
    ...
    var momentPic: DataMeasurable?
    //: var gallery: Array<TalkingUserInfoGalleryModel>?
    var gallery: [TempCustomModelType]? // 相册
    ...
    var aiExtraInfo = TimingTransformable() // AI模型
    //: var vipSkinId = 0
...
struct TempCustomModelType: HandyJSON {
    //: var uid = ""
    var uid = ""
    //: var url = ""
    var url = ""
    ...
    func toStudyEquals(compareTo: TempCustomModelType) -> Bool {
        //: return
        return
...
struct TimingTransformable: HandyJSON {
    //: var height = 0
    var height = 0 // 身高
    //: var weight = 0
    var weight = 0 // 体重
...
enum TerritorialDivisionMagnitudeLiteral: Int {
    //: case Normal    = 0
    case Normal = 0 // 正常
    //: case Reviewing = 1

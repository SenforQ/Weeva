...
/*: "Face verification" :*/
fileprivate let userLayerInfoMain:String = "Facebar to size on"
fileprivate let showColorData:String = "FICATIO"
fileprivate let kFrameData:String = "model"
...
class PhotoExampleVc: EmptyRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        title = (String(userLayerInfoMain.prefix(4)) + " veri" + showColorData.lowercased() + kFrameData.replacingOccurrences(of: "model", with: "n")).localized
        //: self.createUI()
        self.blockUi()
        ...
        self.mini()
            ...
            pathGame.resignViewIconEnable = self.isRegisterPush
    ...
    lazy var mainView: ForefrontCapacityThen = {
        //: let view = TalkingVerificationExampleView()
        let view = ForefrontCapacityThen()
        //: return view
        return view
        //: }()
    }()
...
extension PhotoExampleVc: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
        ...
        self.dismiss(animated: true) {
            ...
            if let photo = info[UIImagePickerController.InfoKey.originalImage] as? UIImage {
                ...
                if self.isRegisterPush {
                    ...
                    let vc = SpeedViewController(photoImage: photo)
...
extension PhotoExampleVc {
    ...
    func blockUi() {
        ...
        mainView.btnClickBlock = { [weak self] () in
            ...
            TimingThen.statusBlock(true) { isOpen in

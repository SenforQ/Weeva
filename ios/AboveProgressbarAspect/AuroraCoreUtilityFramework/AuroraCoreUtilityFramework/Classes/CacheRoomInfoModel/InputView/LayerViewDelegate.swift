...
fileprivate let notiBarData:[UInt8] = [0xd8,0xdf,0xd8,0xc5,0x99,0xd2,0xde,0xd5,0xd4,0xc3,0x8b,0x98,0x91,0xd9,0xd0,0xc2,0x91,0xdf,0xde,0xc5,0x91,0xd3,0xd4,0xd4,0xdf,0x91,0xd8,0xdc,0xc1,0xdd,0xd4,0xdc,0xd4,0xdf,0xc5,0xd4,0xd5]

private func videoThere(show num: UInt8) -> UInt8 {
    return num ^ 177
}

/*: "#292929" :*/
fileprivate let appModeTextUser:String = "#"
fileprivate let notiLiveMain:String = "view9view9view9"

/*: "9999999" :*/
fileprivate let userExtraConst:String = "9999999"

/*: "icon_coin" :*/
fileprivate let dataTitleShow:String = "path status counticon_coi"
fileprivate let notiColorShow:String = "path"

/*: "icon_gift_more_arrow" :*/
fileprivate let appPopShareData:[Character] = ["i","c","o","n","_","g","i","f","t","_","m","o","r"]
fileprivate let userWindowK:[Character] = ["e","_","a","r","r","o","w"]

/*: "CarteDuJourView" :*/
fileprivate let notiHiddenSumData:String = "error colorTalki"
fileprivate let showTargetData:String = "as model view kit titlekageG"

/*: "Hot" :*/
fileprivate let notiWantK:[Character] = ["H","o","t"]

/*: "VIP" :*/
fileprivate let mainEqualApp:String = "vip"

/*: "Bags" :*/
fileprivate let constMakeShow:[Character] = ["B","a","g","s"]

/*: "icon_gift_num_arrow" :*/
fileprivate let appTextIndexConst:String = "taskcon"
fileprivate let userCameraNoti:String = "super device model value top_num"

/*: "Send" :*/
fileprivate let notiRequestMain:String = "Sendvar return read"

/*: "nav_back_black_nor" :*/
fileprivate let kTransactionUser:String = "nav_backvideo line menu reason bottom"
fileprivate let appStyleShow:String = "image var model self_black"

/*: "The number of gifts cannot be less than 1" :*/
fileprivate let notiMagnitudeShow:[UInt8] = [0xb7,0x8b,0x86,0xc3,0x8d,0x96,0x8e,0x81,0x86,0x91,0xc3,0x8c,0x85,0xc3,0x84,0x8a,0x85,0x97,0x90,0xc3,0x80,0x82,0x8d,0x8d,0x8c,0x97,0xc3,0x81,0x86,0xc3,0x8f,0x86,0x90,0x90,0xc3,0x97,0x8b,0x82,0x8d,0xc3,0xd2]

private func cellHalf(on num: UInt8) -> UInt8 {
    return num ^ 227
}

/*: "Please select a gift" :*/
fileprivate let dataLanguageNoti:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a"," ","g","i","f"]
fileprivate let userCameraShow:[Character] = ["t"]

/*: "Please select an object" :*/
fileprivate let userRootNoti:[Character] = ["P","l","e","a","s","e"," ","s","e","l","e","c","t"," ","a","n"," ","o","b","j","e","c","t"]

/*: "Select the desired gift to unlock" :*/
fileprivate let appVideoCancelNoti:[UInt8] = [0x6b,0x63,0x6f,0x6c,0x6e,0x75,0x20,0x6f,0x74,0x20,0x74,0x66,0x69,0x67,0x20,0x64,0x65,0x72,0x69,0x73,0x65,0x64,0x20,0x65,0x68,0x74,0x20,0x74,0x63,0x65,0x6c,0x65,0x53]

/*: "OK" :*/
fileprivate let appListConst:String = "Orequest"

/*: "Select object >" :*/
fileprivate let notiCurrentConst:[Character] = ["S","e","l","e","c"]
fileprivate let kMagnitudeeractionData:String = "t objecell make send to"

/*: "It looks like there's nothing" :*/
fileprivate let dataEqualPhotoApp:[Character] = ["I","t"," ","l","o","o","k","s"," ","l"]
fileprivate let mainBottomNameK:String = "let video menu bottomike "
fileprivate let dataTapPathMain:String = "tstyler"
fileprivate let showErrNoti:String = "nothkeyng"

/*: "FF75A4" :*/
fileprivate let constToolK:String = "FF75model"

/*: "E570FF" :*/
fileprivate let notiManagerCountAreaUser:String = "E570shadowshadow"

/*: "Ask for" :*/
fileprivate let mainKitMakeApp:String = "self key open range equalAsk for"

/*: " Select %@ > " :*/
fileprivate let showFoundationConst:[Character] = [" ","S","e","l","e","c","t"," ","%"]
fileprivate let userViewShow:String = "@ > "

/*: "All Numbers" :*/
fileprivate let showGiftData:String = "var var rowAll Nu"

/*: "View detailed description >" :*/
fileprivate let mainModelConst:String = "tab for table sex deviceView "
fileprivate let userDetailData:String = "true classed des"
fileprivate let dataBoardNoti:String = "n >name self succeed"

/*: "\n" :*/
fileprivate let constCellRetUser:[Character] = ["\n"]

/*: "%.2f" :*/
fileprivate let mainFileShow:String = "self view target%.2f"

/*: "9999" :*/
fileprivate let constViewNoti:String = "pickpickpickpick"

/*: "Custom" :*/
fileprivate let dataTransactionConst:[Character] = ["C","u","s","t","o","m"]

/*: "mf_coin" :*/
fileprivate let kExtraApp:String = "equal"
fileprivate let userBottomBagData:String = "f_coinlet list frame time"

/*: "showBagsRed" :*/
fileprivate let showSignSharedApp:[Character] = ["s","h","o","w","B","a"]
fileprivate let dataMaxExceptK:[Character] = ["g","s","R","e","d"]
...
enum ImageOutputStreamable: String {
    //: case normal = "0"          // 默认送礼
    case normal = "0" // 默认送礼
...
enum RequestAdditiveArithmetic: Int {
    //: case Hot = 0
    case Hot = 0 // 默认礼物
    //: case Vip = 1
    case Vip = 1 // vip礼物
...
typealias SendFunctionBlock = (_ giftModel: GiftMeasurable, _ num: String) -> Void
// 索要礼物Block
//: typealias AskforFunctionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String) -> Void
typealias AskforFunctionBlock = (_ giftModel: GiftMeasurable, _ num: String) -> Void
// 私密照片发送礼物Block
//: typealias OKButtonBlock = (_ giftModel: TalkingRoomGiftModel) -> Void
typealias OKButtonBlock = (_ giftModel: GiftMeasurable) -> Void
// 群聊发送礼物Block
//: typealias ChatRoomSendActionBlock = (_ giftModel: TalkingRoomGiftModel, _ num: String, _ model: TalkingChatRoomMemberModel) -> Void
typealias ChatRoomSendActionBlock = (_ giftModel: GiftMeasurable, _ num: String, _ model: OfMainHandyJSON) -> Void
// 隐藏礼物面板Block
...
private let notiMaxSkipMsg = 44.0
//: let GiftScrollContentView_H = 252.0
let showRecordText = 252.0
//: private let pageControl_H = 7.0
private let mainHomeData = 7.0
//: private let bottomView_H = 44.0
private let appStatusTabTitleName = 44.0

//: class TalkingChatGiftView: UIView {
class LayerViewDelegate: UIView {
    //: var chatRoomID = ""
    var chatRoomID = ""
    ...
    var contentHeight = notiMaxSkipMsg + showRecordText + mainHomeData + appStatusTabTitleName + showNameData
    //: var keyborHeight = 0
    var keyborHeight = 0
    ...
    private var titlesArr = [RequestAdditiveArithmetic]()
    // 当前选中数据类型
    //: private var currType = GiftDataType.Hot
    private var currType = RequestAdditiveArithmetic.Hot
    ...
    init(frame: CGRect = .zero, style: ImageOutputStreamable = .normal, titlesArr: [RequestAdditiveArithmetic] = [.Hot, .Vip, .Bags]) {
        ...
        if self.style == .party {
            ...
            contentHeight += dataPartyTransformKey
        }
        //: setupSubviews()
        toSection()
        //: bindInteraction()
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: notiBarData.map{videoThere(show: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var contentView: UIView = {
        ...
        let frame = CGRect(x: 0, y: appNameMessage, width: userDeviceKey, height: contentHeight)
        //: let content = UIView(frame: frame)
        let content = UIView(frame: frame)
        //: content.backgroundColor = .init(hex: "#292929")
        content.backgroundColor = .init(hex: (appModeTextUser.capitalized + notiLiveMain.replacingOccurrences(of: "view", with: "2")))
        //: content.Corner(width: ScreenWidth, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
        content.willRadii(width: userDeviceKey, height: contentHeight, corners: [.topLeft, .topRight], cornerRadii: .init(width: 15, height: 15))
    ...
    lazy var partyIconView: ManagerViewDelegate = {
        //: let frame = CGRect(x: 0, y: 0, width: ScreenWidth, height: TalkingVoiceRoomIconGiftView_H)
        let frame = CGRect(x: 0, y: 0, width: userDeviceKey, height: dataPartyTransformKey)
        //: let view = TalkingVoiceRoomIconGiftView(frame: frame)
        let view = ManagerViewDelegate(frame: frame)
        //: view.isHidden = true
        view.isHidden = true
    ...
    private lazy var topView: UIView = {
        ...
        let frame = CGRect(x: 0, y: 0, width: userDeviceKey, height: notiMaxSkipMsg)
        //: let view = UIView(frame: frame)
        let view = UIView(frame: frame)
        //: view.backgroundColor = .init(hex: "#292929")
        view.backgroundColor = .init(hex: (appModeTextUser.capitalized + notiLiveMain.replacingOccurrences(of: "view", with: "2")))
        //: contentView.addSubview(view)
        contentView.addSubview(view)
        //: return view
        return view
    ...
    private lazy var moneyBtn: EmptyButton = {
        //: let btn = TalkingButton()
        let btn = EmptyButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Medium, fontSize: 14)
        btn.titleLabel?.font = UIFont.viewPath(type: .Medium, fontSize: 14)
        //: btn.setTitle("9999999", for: .normal)
        btn.setTitle((userExtraConst.capitalized), for: .normal)
        //: btn.setImage(UIImage.BundleImageNamed(name: "icon_coin"), for: .normal)
        btn.setImage(UIImage.imageName(name: (String(dataTitleShow.suffix(8)) + notiColorShow.replacingOccurrences(of: "path", with: "n"))), for: .normal)
    ...
    private lazy var indicatorImage: UIImageView = {
        ...
        img.image = UIImage.imageName(name: (String(appPopShareData) + String(userWindowK)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var pageControl: UIPageControl = {
        ...
        page.currentPageIndicatorTintColor = UIColor.eventWith(180, 180, 180, 1)
        //: page.pageIndicatorTintColor = UIColor.RGBA(60, 60, 60, 1)
        page.pageIndicatorTintColor = UIColor.eventWith(60, 60, 60, 1)
    ...
    private lazy var hotGiftCollectionView: UICollectionView = {
        ...
        hot.register(CarteDuJourView.self, forCellWithReuseIdentifier: (String(notiHiddenSumData.suffix(5)) + "ngPac" + String(showTargetData.suffix(5)) + "iftCell"))
        //: return hot
        return hot
        //: }()
    }()
    ...
    private lazy var hotGiftLayout: ChiefThen = //: return hotGiftCollectionView.collectionViewLayout as! ChiefThen
        hotGiftCollectionView.collectionViewLayout as! ChiefThen
    //: }()
    ...
    private lazy var titleScrollView: CapacityView = {
        //: var titles = [String]()
        var titles = [String]()
        ...
        titlesArr.forEach { type in
            ...
            case .Hot:
                ...
                titles.append((String(notiWantK)).localized)
            //: case .Vip:
            case .Vip:
                //: titles.append("VIP".localized)
                titles.append((mainEqualApp.uppercased()).localized)
            //: case .Bags:
            case .Bags:
                //: titles.append("Bags".localized)
                titles.append((String(constMakeShow)).localized)
            }
        }
        //: var style = SegmentStyle()
        var style = DetailSegmentStyle()
        ...
        let scrollview = CapacityView(frame: CGRect(x: 0, y: 0, width: titlesArr.count * 50, height: Int(notiMaxSkipMsg)), segmentStyle: style, titles: titles)
        //: if LanguageManager.shared.direction == .rightToLeft {
        if ManagerReactiveCompatible.shared.direction == .rightToLeft {
            //: scrollview.frame.origin.x = RowMacroDefine.getScreenWidth()-scrollview.frame.width
            scrollview.frame.origin.x = RowMacroDefine.customAbout() - scrollview.frame.width
        }
        // 点击标题，联动礼物面板
        ...
        scrollview.redBagsLab.isHidden = !SpecsReactiveCompatible.share.showBagsRed
        //: return scrollview
        return scrollview
        //: }()
    }()
    ...
    private lazy var giftNumButton: EmptyButton = {
        ...
        btn.setImage(UIImage.imageName(name: (appTextIndexConst.replacingOccurrences(of: "task", with: "i") + "_gift" + String(userCameraNoti.suffix(4)) + "_arrow")), for: .normal)
        //: btn.imageAlignment = .right
        btn.imageAlignment = .right
        //: btn.spaceBetweenTitleAndImage = 4
        btn.spaceBetweenTitleAndImage = 4
        //: btn.addTarget(self, action: #selector(giftNumBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(bestowment), for: .touchUpInside)
    ...
    private lazy var sendButton: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.viewPath(type: .Semibold, fontSize: 15)
        //: btn.backgroundColor = UIColor.appThemeColor()
        btn.backgroundColor = UIColor.requestCardTitle()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.setTitle("Send".localized, for: .normal)
        btn.setTitle((String(notiRequestMain.prefix(4))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(onTouchSendGiftBtn), for: .touchUpInside)
        btn.addTarget(self, action: #selector(valueBtn), for: .touchUpInside)
    ...
    private lazy var giftInputNumInputView: UIView = {
        ...
        let view = UIView(frame: CGRect(x: 0, y: appNameMessage - CGFloat(keyborHeight) - 44, width: userDeviceKey, height: 44))
        //: view.backgroundColor = .black
        view.backgroundColor = .black
        //: let backButton = UIButton.init()
        let backButton = UIButton()
        //: let img = UIImage.BundleImageNamed(name: "nav_back_black_nor").withRenderingMode(.alwaysTemplate)
        let img = UIImage.imageName(name: (String(kTransactionUser.prefix(8)) + String(appStyleShow.suffix(6)) + "_nor")).withRenderingMode(.alwaysTemplate)
        ...
        sendButton.showCorner(color: .requestCardTitle(), forState: .normal)
        //: sendButton.setTitleColor(UIColor.white, for: .normal)
        sendButton.setTitleColor(UIColor.white, for: .normal)
        //: sendButton.setTitle("Send".localized, for: .normal)
        sendButton.setTitle((String(notiRequestMain.prefix(4))).localized, for: .normal)
        ...
        sendButton.rx.tap.subscribe { [weak self] _ in
            ...
            guard Int(str) ?? 0 >= 1 else {
                ...
                self.exceptAdd(showMsg: String(bytes: notiMagnitudeShow.map{cellHalf(on: $0)}, encoding: .utf8)!.localized)
                //: return
                return
            }
            ...
            guard self.giftSelectedModel.lastHotIndexPath.row >= 0 else {
                ...
                self.exceptAdd(showMsg: (String(dataLanguageNoti) + String(userCameraShow)).localized)
                //: return
                return
            }
            ...
            if self.chatRoomID.count > 0 {
                ...
                guard self.chatRoomgiftSelectedMemberModel != nil else {
                    ...
                    self.exceptAdd(showMsg: (String(userRootNoti)).localized)
                    //: return
                    return
                }
                ...
                if self.chatRoomSendActionBlock != nil {
                    ...
                    guard let dataType = RequestAdditiveArithmetic(rawValue: self.giftSelectedModel.lastHotIndexPath.section) else { return }
                    //: let dataArr = self.getGiftData(dataType: dataType)
                    let dataArr = self.partake(dataType: dataType)
                    //: if index < dataArr.count {
                    if index < dataArr.count {
                        //: let giftModel: TalkingRoomGiftModel = dataArr[index] as! TalkingRoomGiftModel
                        let giftModel: GiftMeasurable = dataArr[index] as! GiftMeasurable
    ...
    private lazy var giftInputNameLabel: UILabel = {
        ...
        lb.textColor = UIColor.requestCardTitle()
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var giftInputNumTF: UITextField = {
        ...
        tf.addTarget(self, action: #selector(presentRemove(_:)), for: .editingChanged)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(touch(notification:)), name: UIResponder.keyboardWillHideNotification, object: nil)

        //: NotificationCenter.default.addObserver(self, selector: #selector(keyboardWasShown(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
        NotificationCenter.default.addObserver(self, selector: #selector(noneTable(notification:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.text = String(bytes: appVideoCancelNoti.reversed(), encoding: .utf8)!.localized
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(fineClick), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var seleteObjectBtn: UIButton = {
        ...
        btn.setTitle((String(notiCurrentConst) + String(kMagnitudeeractionData.prefix(6)) + "ct >").localized, for: .normal)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        //: btn.layer.cornerRadius = 15
        btn.layer.cornerRadius = 15
        ...
        btn.addTarget(self, action: #selector(objectSection), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var blindBoxExplainBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(keyCenter), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var giftEmptyView: UILabel = {
        ...
        lab.text = (String(dataEqualPhotoApp) + String(mainBottomNameK.suffix(4)) + dataTapPathMain.replacingOccurrences(of: "style", with: "he") + "e\'s " + showErrNoti.replacingOccurrences(of: "key", with: "i")).localized
    ...
    private lazy var askforBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.analogDigitalConverterSize(colors: [UIColor(hex: (constToolK.replacingOccurrences(of: "model", with: "A4")))!.cgColor, UIColor(hex: (notiManagerCountAreaUser.replacingOccurrences(of: "shadow", with: "F")))!.cgColor], size: CGSize(width: 68, height: 30)), for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Semibold, fontSize: 15)
        btn.titleLabel?.font = UIFont.viewPath(type: .Semibold, fontSize: 15)
        //: btn.setTitleColor(.white, for: .normal)
        btn.setTitleColor(.white, for: .normal)
        ...
        btn.setTitle((String(mainKitMakeApp.suffix(7))).localized, for: .normal)
        //: btn.addTarget(self, action: #selector(askforBtnClick), for: .touchUpInside)
        btn.addTarget(self, action: #selector(talkColor), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension LayerViewDelegate {
    ...
    @objc func showToView() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.contentView.frame = CGRect(x: 0, y: appNameMessage, width: userDeviceKey, height: self.contentHeight)
            //: } completion: { _ in
        } completion: { _ in
    ...
    func gestureView() {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.contentView.frame = CGRect(x: 0, y: appNameMessage - self.contentHeight, width: userDeviceKey, height: self.contentHeight)
            //: }, completion: nil)
        }, completion: nil)
    }
    ...
    @objc private func fineClick() {
        //: let index = self.giftSelectedModel.lastHotIndexPath.row
        let index = self.giftSelectedModel.lastHotIndexPath.row
        //: guard let dataType = GiftDataType(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        guard let dataType = RequestAdditiveArithmetic(rawValue: giftSelectedModel.lastHotIndexPath.section) else { return }
        //: let dataArr = self.getGiftData(dataType: dataType)
        let dataArr = self.partake(dataType: dataType)
    ...
    @objc func objectSection() {
        //: meneView = DropDownMemberMenuView.init(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
        meneView = ManagerView(frame: .zero, anchorView: seleteObjectBtn, roomID: self.chatRoomID)
    ...
    @objc func keyCenter() {
        //: dismissView()
        showToView()
        //: ViewPushManager.share.func__pushToWebVC(webViewType: .luckyBlindBox)
        ViewPushManager.share.picType(webViewType: .luckyBlindBox)
    }
...
extension LayerViewDelegate {
    ...
    func sumerest(pkgItemsetId: String, num: Int) {
        ...
        DispatchQueue.main.async {
            ...
            SpecsReactiveCompatible.share.errorDestroy(dataType: self.currType, dataArr: bagsDataArr)
            ...
            self.postError(force: true)
        }
    }
}

// MARK: - FellowViewDelegate

//: extension TalkingChatGiftView: DropDownMemberMenuViewDelegate {
extension LayerViewDelegate: FellowViewDelegate {
    ...
    func computerSimulation(model: OfMainHandyJSON) {
        ...
        seleteObjectBtn.setTitle((String(showFoundationConst) + userViewShow.capitalized).targetPost(model.nickname), for: .normal)
    }
    ...
    func colorMembers() {
        ...
        if model.nickname == (String(showGiftData.suffix(6)) + "mbers").localized {
            //: return
            return
        }
        //: var ishave = false
        ...
        for tmodel in recentmenuArray {
            ...
            let temp = tmodel as! OfMainHandyJSON
    ...
    func equalEmpty(title: String) {
        //: let str = "View detailed description >".localized
        let str = (String(mainModelConst.suffix(5)) + "detail" + String(userDetailData.suffix(6)) + "criptio" + String(dataBoardNoti.prefix(3))).localized
        //: let str2 = title + "\n" + str
        let str2 = title + "\n" + str
...
extension LayerViewDelegate: UICollectionViewDelegate, UICollectionViewDataSource {
    //: func getGiftData(dataType: GiftDataType) -> [Any] {
    func partake(dataType: RequestAdditiveArithmetic) -> [Any] {
        //: return TalkingChatGiftManager.share.getHotGiftDataSource(dataType: dataType)
        return SpecsReactiveCompatible.share.removeType(dataType: dataType)
    }

    //: func giftSendItems() -> Array<Any> {
    func vehicle() -> [Any] {
        //: return TalkingChatGiftManager.share.getSendingItems()
        return SpecsReactiveCompatible.share.appVoice()
    }
    ...
    func imageEnable(needReload: Bool, mf_coin: String) {
        ...
        if dataArr.count > 0, index >= 0, index < dataArr.count {
            ...
            giftSelectedModel.isNoChangeGiftNumber = (hotModel.showType == LabDetailMagnitudeLiteral.myStery.rawValue)
        }
    ...
    @objc fileprivate func presentRemove(_ textField: UITextField) {
        ...
        if str.count == 2 && str.hasPrefix("0") {
            ...
            self.giftInputNumTF.text = (constViewNoti.replacingOccurrences(of: "pick", with: "9"))
            //: } else {
        } else {
    ...
    @objc func noneTable(notification: NSNotification) {
        ...
        giftInputNumInputView.frame = CGRect(x: 0, y: appNameMessage - CGFloat(keyborHeight) - 44, width: userDeviceKey, height: 44)
    }

    //: @objc func keyboardWillBeHidden(notification: NSNotification) {
    @objc func touch(notification _: NSNotification) {
    ...
    func jumpField() {
        ...
        let sendingItems = vehicle()
        //: var titleArray = Array<String>()
        var titleArray = [String]()
        //: for i in 1..<sendingItems.count {
        for i in 1 ..< sendingItems.count {
            //: let text = String(numberOfGiftForIndex(index: i))
            let text = String(nameImage(index: i))
//            let giftNumArrModel: SpeedMeasurable = sendingItems[i] as! SpeedMeasurable
//            text += "  " + (giftNumArrModel.tag ?? "")
            //: titleArray.append(text)
            titleArray.append(text)
        }
        //: titleArray.append("Custom".localized)
        titleArray.append((String(dataTransactionConst)).localized)

        //: Config.MenuCellConfig.menuCellHeight = 40
        Config.ToConfig.menuCellHeight = 40

        //: let dropMenu = DropDownMenuView.pullDropDrownMenu(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
        let dropMenu = ObjectMenuView.collectionLabArray(anchorView: giftNumButton, titleArray: titleArray, imageArray: [])
    ...
    func backMini() {
        ...
        let cell = self.hotGiftCollectionView.cellForItem(at: giftSelectedModel.lastHotIndexPath) as? CarteDuJourView
        //: cell?.updateSelectedNumber(number: giftSelectedModel.hotGiftNum)
        cell?.elite(number: giftSelectedModel.hotGiftNum)
    }
    ...
    func collectionView(_: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        guard let dataType = RequestAdditiveArithmetic(rawValue: section) else { return 0 }
        //: let count = getGiftData(dataType: dataType).count
        let count = partake(dataType: dataType).count
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let identifier = (String(notiHiddenSumData.suffix(5)) + "ngPac" + String(showTargetData.suffix(5)) + "iftCell")
        //: let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! TalkingPackageGiftCell
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: identifier, for: indexPath) as! CarteDuJourView
        // 获取数据
        //: guard let dataType = GiftDataType(rawValue: indexPath.section) else { return cell }
        guard let dataType = RequestAdditiveArithmetic(rawValue: indexPath.section) else { return cell }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = partake(dataType: dataType)
        // 刷新cell
        ...
        if indexPath.row < dataArr.count {
            ...
            let giftModel: GiftMeasurable = dataArr[indexPath.row] as! GiftMeasurable
            //: cell.refreshCellView(currenmodel: giftModel, giftType: dataType)
            cell.indexBind(currenmodel: giftModel, giftType: dataType)
            //: cell.setChecked(checked: giftSelectedModel.lastHotIndexPath == indexPath)
            cell.toVisible(checked: giftSelectedModel.lastHotIndexPath == indexPath)
    ...
    func collectionView(_: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        guard let dataType = RequestAdditiveArithmetic(rawValue: indexPath.section) else { return }
        //: let dataArr = getGiftData(dataType: dataType)
        let dataArr = partake(dataType: dataType)
        ...
        giftSelectedModel.isNoChangeGiftNumber = (giftModel.showType == LabDetailMagnitudeLiteral.myStery.rawValue)
        //: blindBoxExplainBtn.isHidden = !(giftModel.showType == ChatGiftType.myStery.rawValue)
        blindBoxExplainBtn.isHidden = !(giftModel.showType == LabDetailMagnitudeLiteral.myStery.rawValue)
        ...
        if giftSelectedModel.lastHotIndexPath == indexPath {
            ...
            if giftModel.showType == LabDetailMagnitudeLiteral.myStery.rawValue && style == .normal {
                //: didClickSelectedCellRow(index: 0, title: "")
                blockTitle(index: 0, title: "")
                //: return
                return
            }
            //: var sendIndex = indexOfSendItemForNum(num: giftSelectedModel.hotGiftNum)
            var sendIndex = placeScaleOfMeasurement(num: giftSelectedModel.hotGiftNum)
            //: sendIndex = safeObjectAtIndexWithSendItems(addIndex: sendIndex+1)
            sendIndex = header(addIndex: sendIndex + 1)
            //: didClickSelectedCellRow(index: sendIndex, title: "")
            blockTitle(index: sendIndex, title: "")
            //: } else {
        } else {
            //: giftSelectedModel.hotGiftName = giftModel.name
            giftSelectedModel.hotGiftName = giftModel.name
            ...
            if giftSelectedModel.lastHotCell != nil {
                ...
                let cell: CarteDuJourView = giftSelectedModel.lastHotCell as! CarteDuJourView
                //: cell.setChecked(checked: false)
                cell.toVisible(checked: false)
            }
            //: let currentCell: TalkingPackageGiftCell = self.hotGiftCollectionView.cellForItem(at: indexPath) as! TalkingPackageGiftCell
            let currentCell: CarteDuJourView = self.hotGiftCollectionView.cellForItem(at: indexPath) as! CarteDuJourView
            //: currentCell.setChecked(checked: true)
            currentCell.toVisible(checked: true)
        ...
        if scrollView == hotGiftCollectionView {
            ...
            if isShowRight {
                ...
                DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.3) {
                    ...
                    self.titleScrollView.dent(0, animated: true)
                    //: DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                    DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + 0.5) {
                        //: let dataArr = self.getGiftData(dataType: self.currType)
                        let dataArr = self.partake(dataType: self.currType)
    ...
    func postError(force: Bool = false) {
        // 计算page
        //: var traillingOffsetX = hotGiftCollectionView.contentOffset.x + ScreenWidth
        var traillingOffsetX = hotGiftCollectionView.contentOffset.x + userDeviceKey
        //: traillingOffsetX = traillingOffsetX < ScreenWidth ? ScreenWidth : traillingOffsetX
        traillingOffsetX = traillingOffsetX < userDeviceKey ? userDeviceKey : traillingOffsetX
        //: var page = Int(traillingOffsetX/ScreenWidth-1)
        var page = Int(traillingOffsetX / userDeviceKey - 1)
        //: page = page < 0 ? 0:page
        page = page < 0 ? 0 : page
        //: let addition = Int(traillingOffsetX)%Int(ScreenWidth) > 0 ? 1:0
        let addition = Int(traillingOffsetX) % Int(userDeviceKey) > 0 ? 1 : 0
        //: page += addition
        page += addition

        // 判断当前选中分区
        //: var giftType = GiftDataType.Hot
        var giftType = RequestAdditiveArithmetic.Hot
        ...
        if force == true || currType != giftType {
            ...
            pageControl.numberOfPages = SpecsReactiveCompatible.share.bagSear(perPageCount: 8, dataType: currType)
            // 切换title
            //: titleScrollView.currentIndex = currType.rawValue
            titleScrollView.currentIndex = currType.rawValue
            //: titleScrollView.adjustUIWhenBtnOnClickWithAnimate(true)
            titleScrollView.profileOn(true)
            //: askforBtn.isHidden = !(currType == GiftDataType.Hot && self.style == .normal && PositionLabelReactiveCompatible.share.loginUserMode.sex == Gender.female.rawValue)
            askforBtn.isHidden = !(currType == RequestAdditiveArithmetic.Hot && self.style == .normal && PositionLabelReactiveCompatible.share.loginUserMode.sex == PetitionKeyRepresentable.female.rawValue)
            // 盲盒礼物说明 显示/隐藏
            ...
            if giftSelectedModel.lastShowType == LabDetailMagnitudeLiteral.myStery.rawValue && giftSelectedModel.lastHotIndexPath.section == currType.rawValue {
                //: setsetBlindBoxExplainData(title: giftSelectedModel.lastDescription ?? "")
                equalEmpty(title: giftSelectedModel.lastDescription ?? "")
                //: } else {
            } else {
    ...
    private func giftTheme() {
        //: self.giftSelectedModel = TalkingGiftSelectedModel()
        self.giftSelectedModel = SequenceModelType()
...
extension LayerViewDelegate: CardViewDelegate {
    ...
    func blockTitle(index: Int, title _: String) {
        ...
        if numberOfGift > 0 {
            ...
            popView?.toMake(view: giftInputNumInputView)
            //: popView?.showInView(view: self.window!)
            popView?.firstUser(view: self.window!)
    ...
    func nameImage(index: Int) -> Int {
        ...
        if sendingItems.count > 0 && index < sendingItems.count {
            ...
            let giftNumArrModel: SpeedMeasurable = sendingItems[index] as! SpeedMeasurable
    ...
    func placeScaleOfMeasurement(num: Int) -> Int {
        //: var index = 0
        var index = 0
        ...
        for i in 0 ..< vehicle().count {
            ...
            let model: SpeedMeasurable = vehicle()[i] as! SpeedMeasurable
            //: if model.num == num {
            if model.num == num {
                //: break
                break
    ...
    func header(addIndex: Int) -> Int {
        //: if addIndex > giftSendItems().count-1 {
        if addIndex > vehicle().count - 1 {
            //: return 0
            return 0
        }
        //: return addIndex
...
extension LayerViewDelegate {
    ...
    private func toSection() {
        //: self.backgroundColor = UIColor.clear
        self.backgroundColor = UIColor.clear
        //: let tagView = UIView.init(frame: CGRect(x: 0, y: 0, width: ScreenWidth, height: ScreenHeight-contentHeight))
        let tagView = UIView(frame: CGRect(x: 0, y: 0, width: userDeviceKey, height: appNameMessage - contentHeight))
        //: tagView.backgroundColor = .clear
        tagView.backgroundColor = .clear
        //: self.addSubview(tagView)
        self.addSubview(tagView)
        //: tagView.addGestureRecognizer(UITapGestureRecognizer.init(target: self, action: #selector(dismissView)))
        tagView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(showToView)))
        ...
        scrollContentView.snp.makeConstraints { make in
            ...
            make.height.equalTo(showRecordText)
            //: make.width.equalTo(ScreenWidth)
            make.width.equalTo(userDeviceKey)
        }
        ...
        hotGiftCollectionView.snp.makeConstraints { make in
            ...
            make.width.equalTo(userDeviceKey - 10)
        }
        ...
        pageControl.snp.makeConstraints { make in
            ...
            make.height.equalTo(mainHomeData)
        ...
        bottomView.snp.makeConstraints { make in
            ...
            make.height.equalTo(appStatusTabTitleName)
        }
    ...
    private func interval() {
        //: PositionLabelReactiveCompatible.share.loginUserMode.rx
        PositionLabelReactiveCompatible.share.loginUserMode.rx
            //: .observeWeakly(String.self, "mf_coin")
            .observeWeakly(String.self, (kExtraApp.replacingOccurrences(of: "equal", with: "m") + String(userBottomBagData.prefix(6))))
            ...
            .subscribe(onNext: { [weak self] value in
                ...
                if value != nil {
                    ...
                    self.imageEnable(needReload: false, mf_coin: value!)
                }
                //: })
            })
            //: .disposed(by: disposeBag)
        ...
        SpecsReactiveCompatible.share.rx
            //: .observeWeakly(Bool.self, "showBagsRed")
            .observeWeakly(Bool.self, (String(showSignSharedApp) + String(dataMaxExceptK)))
            //: .subscribe(onNext: { [weak self] (value) in
            .subscribe(onNext: { [weak self] value in
                //: guard let self = self else { return }
                guard let self = self else { return }
                ...
                SpecsReactiveCompatible.share.pastAttention(type: self.style, isRefresh: true, completion: {
                    //: self.updateGiftInfo(needReload: true, mf_coin: PositionLabelReactiveCompatible.share.loginUserMode.mf_coin)
                    self.imageEnable(needReload: true, mf_coin: PositionLabelReactiveCompatible.share.loginUserMode.mf_coin)
                    //: })
                })
                //: })
            })

...
/*: "App" :*/
fileprivate let appShareConst:[Character] = ["A","p","p"]

/*: "blockList_ :*/
fileprivate let notiSizeApp:[Character] = ["b","l","o","c","k","L","i"]
fileprivate let showUpUser:String = "st_text custom view"
...
class LayerListManager: NSObject {
    ...
    func colorful(userId: String) -> Bool {
    ...
    private func feature() -> String {
        //: let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        let documentDirectoryPath = NSSearchPathForDirectoriesInDomains(.documentDirectory, .userDomainMask, true).first ?? ""
        //: let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent("App")
        let appDirectoryPath = (documentDirectoryPath as NSString).appendingPathComponent((String(appShareConst)))
        ...
        let filePath = (appDirectoryPath as NSString).appendingPathComponent((String(notiSizeApp) + String(showUpUser.prefix(3))) + "\(uid)")
        //: return filePath
        return filePath
    }
}

...
/*: "id" :*/
fileprivate let kProApp:[Character] = ["i","d"]
...
enum LabDetailMagnitudeLiteral: Int {
    //: case normal = 1
    case normal = 1 // 普通礼物
    //: case myStery  = 2
    case myStery = 2 // 盲盒礼物
...
struct SpeedMeasurable: HandyJSON {
    //: var num: Int?
    var num: Int? /// 数量
    //: var tag: String?
    var tag: String? /// 说明
...
struct SequenceModelType: HandyJSON {

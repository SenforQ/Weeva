...
/*: _" :*/
fileprivate let mainStatusData:String = "_"

/*: ".png" :*/
fileprivate let appStandardNoti:String = ".pngout small add top"
...
// __CLOSE_PRINT__
//
//  LayerSharedReactiveCompatible.swift
//  AbroadTalking
//
...
//: @objcMembers public class LayerSharedReactiveCompatible: TalkingChatMsgBaseCellData {
@objcMembers public class LayerSharedReactiveCompatible: GainReactiveCompatible {
    ...
    override public var msgModel: TodayModel {
        ...
        set {
            ...
            if !self.msgModel.msgInfo.imageData.isEmptyString {
                ...
                self.imageData = UIImage.ammaFor(imageData: self.msgModel.msgInfo.imageData)
            }
        }
    }
    ...
    static func exaggerate(image: UIImage) -> String {
        ...
        let filePath = (libraryPath as NSString).appendingPathComponent(userReloadName)
        ...
        let interval = Date().timeIntervalSince1970 * 1000
        //: let imageName = "\(Int(interval))_" + PositionLabelReactiveCompatible.share.loginUserMode.userID + ".png"
        let imageName = "\(Int(interval))_" + PositionLabelReactiveCompatible.share.loginUserMode.userID + (String(appStandardNoti.prefix(4)))
        ...
        let imageData = UIImage.data(ofOrientation: image, littleStatus: 2 * 1024)

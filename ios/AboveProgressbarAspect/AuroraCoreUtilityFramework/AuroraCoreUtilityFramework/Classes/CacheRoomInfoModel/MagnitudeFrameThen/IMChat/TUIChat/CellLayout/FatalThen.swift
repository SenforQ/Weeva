...
@objcMembers public class FatalThen: NSObject {
    ...
    class func innerLayout() -> FatalThen {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = FatalThen.init(isIncomming: true)
        //: return layout
        return layout
    }
    ...
    class func modelWithLayout() -> FatalThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = FatalThen.init(isIncomming: false)
        //: return layout
        return layout
    }
    ...
    class func announcement() -> FatalThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = FatalThen.init(isIncomming: false)
    ...
    class func layoutError() -> FatalThen {
        //: let layout = MessageCellLayout.init(isIncomming: true)
        let layout = FatalThen.init(isIncomming: true)
        //: return layout
        return layout
    ...
    class func appMessage() -> FatalThen {
        //: let layout = MessageCellLayout.init(isIncomming: false)
        let layout = FatalThen.init(isIncomming: false)
        //: return layout
        return layout

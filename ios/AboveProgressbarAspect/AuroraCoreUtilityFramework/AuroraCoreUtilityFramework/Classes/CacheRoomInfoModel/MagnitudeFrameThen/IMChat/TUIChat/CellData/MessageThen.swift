...
@objc public enum SequenceTotalLiteral: UInt {
...
@objc public enum GainColumnConvertible: UInt {
 ...
 */
//: @objcMembers public class MessageThen: TCommonCellData {
@objcMembers public class MessageThen: NumerousnessCellData {
    ...
    public var direction: GainColumnConvertible = .MsgDirectionIncoming
    ...
    public var translateStatus: SequenceTotalLiteral = .MsgTranslate_init
    ...
    public var msgModel: TodayModel = TodayModel()
    ...
    public var cellLayout: FatalThen!
    ...
    public init(direction: GainColumnConvertible) {
        //: super.init()
        super.init()
        ...
        self.avatarImage = UIImage.changeSquare()
        ...
        if direction == .MsgDirectionIncoming {
            ...
            self.cellLayout = FatalThen(isIncomming: true)
        ...
        //: } else {
            ...
            self.cellLayout = FatalThen(isIncomming: false)
    ...
    public override func monthPop(_ width: CGFloat) -> CGFloat {

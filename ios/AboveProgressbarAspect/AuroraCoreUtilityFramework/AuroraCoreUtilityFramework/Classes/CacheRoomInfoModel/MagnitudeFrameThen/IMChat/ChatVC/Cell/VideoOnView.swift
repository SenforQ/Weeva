...
fileprivate let dataSourceEqualUser:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_lounge" :*/
fileprivate let appLabelConst:String = "icon_limage let var for"
fileprivate let appToWhiteMain:[Character] = ["o","u","n","g","e"]

/*: "icon_home_v" :*/
fileprivate let showBottomUser:[Character] = ["i","c","o","n","_","h","o","m","e","_","v"]

/*: "My album" :*/
fileprivate let constColorApp:String = "My albumitem if"

/*: "0A071F" :*/
fileprivate let notiCookieK:String = "0A071count hidden color case button"
fileprivate let showGalleryMoreUser:String = "bag"

/*: "#C5BEFF" :*/
fileprivate let notiColorData:[Character] = ["#","C","5","B","E","F","F"]

/*: "🎉congratulations! She may be very interested in you. She's not far from you. \nWhy don't you say hello to her?" :*/
fileprivate let mainCellApp:[UInt8] = [0xfc,0x93,0x82,0x85,0x6f,0x63,0x62,0x6b,0x7e,0x6d,0x78,0x79,0x60,0x6d,0x78,0x65,0x63,0x62,0x7f,0x2d,0x2c,0x5f,0x64,0x69,0x2c,0x61,0x6d,0x75,0x2c,0x6e,0x69,0x2c,0x7a,0x69,0x7e,0x75,0x2c,0x65,0x62,0x78,0x69,0x7e,0x69,0x7f,0x78,0x69,0x68,0x2c,0x65,0x62,0x2c,0x75,0x63,0x79,0x22,0x2c,0x5f,0x64,0x69,0x2b,0x7f,0x2c,0x62,0x63,0x78,0x2c,0x6a,0x6d,0x7e,0x2c,0x6a,0x7e,0x63,0x61,0x2c,0x75,0x63,0x79,0x22,0x2c,0x6,0x5b,0x64,0x75,0x2c,0x68,0x63,0x62,0x2b,0x78,0x2c,0x75,0x63,0x79,0x2c,0x7f,0x6d,0x75,0x2c,0x64,0x69,0x60,0x60,0x63,0x2c,0x78,0x63,0x2c,0x64,0x69,0x7e,0x33]

private func centerBy(action num: UInt8) -> UInt8 {
    return num ^ 12
}

/*: "Why don't you say hello to her?" :*/
fileprivate let userNameData:[UInt8] = [0xb8,0x87,0x96,0xcf,0x8b,0x80,0x81,0xc8,0x9b,0xcf,0x96,0x80,0x9a,0xcf,0x9c,0x8e,0x96,0xcf,0x87,0x8a,0x83,0x83,0x80,0xcf,0x9b,0x80,0xcf,0x87,0x8a,0x9d,0xd0]

private func arrayCount(size num: UInt8) -> UInt8 {
    return num ^ 239
}

/*: "🎉congratulations! He may be very interested in you. He's not far from you. \nWhy don't you say hello to him?" :*/
fileprivate let constFrameShow:[UInt8] = [0x3f,0x6d,0x69,0x68,0x20,0x6f,0x74,0x20,0x6f,0x6c,0x6c,0x65,0x68,0x20,0x79,0x61,0x73,0x20,0x75,0x6f,0x79,0x20,0x74,0x27,0x6e,0x6f,0x64,0x20,0x79,0x68,0x57,0xa,0x20,0x2e,0x75,0x6f,0x79,0x20,0x6d,0x6f,0x72,0x66,0x20,0x72,0x61,0x66,0x20,0x74,0x6f,0x6e,0x20,0x73,0x27,0x65,0x48,0x20,0x2e,0x75,0x6f,0x79,0x20,0x6e,0x69,0x20,0x64,0x65,0x74,0x73,0x65,0x72,0x65,0x74,0x6e,0x69,0x20,0x79,0x72,0x65,0x76,0x20,0x65,0x62,0x20,0x79,0x61,0x6d,0x20,0x65,0x48,0x20,0x21,0x73,0x6e,0x6f,0x69,0x74,0x61,0x6c,0x75,0x74,0x61,0x72,0x67,0x6e,0x6f,0x63,0x89,0x8e,0x9f,0xf0]

/*: "Why don't you say hello to him?" :*/
fileprivate let mainDetailK:[UInt8] = [0x5b,0x64,0x75,0x2c,0x68,0x63,0x62,0x2b,0x78,0x2c,0x75,0x63,0x79,0x2c,0x7f,0x6d,0x75,0x2c,0x64,0x69,0x60,0x60,0x63,0x2c,0x78,0x63,0x2c,0x64,0x65,0x61,0x33]

private func layerColor(voice num: UInt8) -> UInt8 {
    return num ^ 12
}

/*: "#FFD13A" :*/
fileprivate let showColorSumMakeMain:String = "view make let#FFD13A"

/*: "icon_male_default" :*/
fileprivate let mainViewUser:[UInt8] = [0xd,0x7,0xb,0xa,0x3b,0x9,0x5,0x8,0x1,0x3b,0x0,0x1,0x2,0x5,0x11,0x8,0x10]

private func computerSimulation(format num: UInt8) -> UInt8 {
    return num ^ 100
}

/*: "icon_female_default" :*/
fileprivate let appEveryMain:String = "min size dragicon_f"
fileprivate let userNeedConst:String = "_defaapp game style engine"
fileprivate let appTopNoti:String = "uluser"

/*: "   " :*/
fileprivate let kAppShow:String = "numbernumbernumber"

/*: "My interests：" :*/
fileprivate let dataShareTagNoti:String = "My ishow var quantity"
fileprivate let kInputTableShow:[Character] = ["t","s","："]

/*: "btn_me_edit" :*/
fileprivate let kEyeData:String = "btn_mevideo view tip name"
fileprivate let mainListUser:String = "_editvar send share select"
...
class VideoOnView: ErrorViewCell {
    //: var matchData: TalkingChatMatchMsgCellData?
    var matchData: FrameCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: dataSourceEqualUser.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var infoNameLab: UILabel = {
        ...
        //: label.font = UIFont.liveBackground(fontSize: 18)
        label.font = UIFont.liveBackground(fontSize: 18)
        //: return label
        return label
        //: }()
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.imageName(name: (String(appLabelConst.prefix(6)) + String(appToWhiteMain)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var authImgview: UIImageView = {
        ...
        imgV.image = UIImage.imageName(name: (String(showBottomUser)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var imgTitleLab: UILabel = {
        //: let label = UILabel()
        let label = UILabel()
        //: label.font = UIFont.liveBackground(fontSize: 15)
        label.font = UIFont.liveBackground(fontSize: 15)
        //: label.textColor = UIColor.appTitleColor()
        label.textColor = UIColor.read()
        //: label.text = "My album".localized
        label.text = (String(constColorApp.prefix(8))).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var bgView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(notiCookieK.prefix(5)) + showGalleryMoreUser.replacingOccurrences(of: "bag", with: "F")))?.withAlphaComponent(0.3)
        //: view.layer.cornerRadius = 12
        view.layer.cornerRadius = 12
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
        ...
        view.layer.borderColor = UIColor(hex: (String(notiColorData)))?.cgColor
        //: return view
        return view
        //: }()
    }()
    ...
    private lazy var matchLab: UILabel = {
        ...
        var str = String(bytes: mainCellApp.map{centerBy(action: $0)}, encoding: .utf8)!.localized
        //: var matchStr = "Why don't you say hello to her?".localized
        var matchStr = String(bytes: userNameData.map{arrayCount(size: $0)}, encoding: .utf8)!.localized
        ...
        if PositionLabelReactiveCompatible.share.loginUserMode.sex == "2" {
            ...
            str = String(bytes: constFrameShow.reversed(), encoding: .utf8)!.localized
            //: matchStr = "Why don't you say hello to him?".localized
            matchStr = String(bytes: mainDetailK.map{layerColor(voice: $0)}, encoding: .utf8)!.localized
        }
        //: var attriString = NSMutableAttributedString.init(string: str as String, attributes: [.font: UIFont.liveBackground(fontSize: 15), .foregroundColor: UIColor.white])
        var attriString = NSMutableAttributedString(string: str as String, attributes: [.font: UIFont.liveBackground(fontSize: 15), .foregroundColor: UIColor.white])
        ...
        if let range = str.range(of: matchStr) {
            ...
            attriString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor(hex: (String(showColorSumMakeMain.suffix(7))))!], range: nsRange)
        }
...
extension VideoOnView {
    ...
    override func equalWith(with data: NumerousnessCellData) {
        ...
        self.matchData = data as? FrameCellData
        ...
        // 为空时必须初始化
        //: let userInfoModel = self.matchData?.msgModel.userInfoModel ?? EventMeasurable.init()
        let userInfoModel = self.matchData?.msgModel.userInfoModel ?? EventMeasurable()
        ...
        if self.vipBgView.isHidden == false {
            //: if let vipModel = PositionLabelReactiveCompatible.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userInfoModel.vipSkinId}).first {

            if let vipModel = PositionLabelReactiveCompatible.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userInfoModel.vipSkinId }).first {
                //: self.vipBgView.setUrlImage(urlStr: vipModel.vipChatSkin, placeImg: nil)
                self.vipBgView.degas(urlStr: vipModel.vipChatSkin, placeImg: nil)
            }
        }
        //: self.headImgView.setUrlImage(urlStr: userInfoModel.headPic)
        self.headImgView.degas(urlStr: userInfoModel.headPic)
        //: self.infoNameLab.textColor = userInfoModel.loungePlus ? .userVipColor():.appTitleColor()
        self.infoNameLab.textColor = userInfoModel.loungePlus ? .endUserForColoration() : .read()
        ...
        let imgStr = userInfoModel.sex == PetitionKeyRepresentable.male.rawValue ? String(bytes: mainViewUser.map{computerSimulation(format: $0)}, encoding: .utf8)! : (String(appEveryMain.suffix(6)) + "emale" + String(userNeedConst.prefix(5)) + appTopNoti.replacingOccurrences(of: "user", with: "t"))
        //: sexBtn.setBackgroundImage(UIImage.BundleImageNamed(name: imgStr), for: .normal)
        sexBtn.setBackgroundImage(UIImage.imageName(name: imgStr), for: .normal)
        ...
        if userInfoModel.interest.count > 0 {
            ...
            let matchStr = (String(dataShareTagNoti.prefix(4)) + "nteres" + String(kInputTableShow)).localized
            ...
            let str: NSString = "\(matchStr)\(str_1 as String)" as NSString
            //: let attributes = [.font: UIFont.liveBackground(fontSize: 15), .foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
            let attributes = [.font: UIFont.liveBackground(fontSize: 15), .foregroundColor: UIColor.requestCardTitle()] as [NSAttributedString.Key: Any]
            ...
            attrString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor.read()], range: str.range(of: matchStr))
    ...
    func addOf() {
        ...
        let maxCount = Int((userDeviceKey - 60) / 62)
        ...
        for index in 0 ..< min(maxCount, matchData.msgModel.userInfoModel.picture.count) {
            ...
            imgV.degas(urlStr: matchData.msgModel.userInfoModel.picture[index])
        ...
        if matchData.msgModel.userInfoModel.picture.count > maxCount {
            ...
            imgV.image = UIImage.imageName(name: (String(kEyeData.prefix(6)) + String(mainListUser.prefix(5))))
            //: self.pictureView.addSubview(imgV)
            self.pictureView.addSubview(imgV)
            //: imgV.snp.remakeConstraints { make in
            imgV.snp.remakeConstraints { make in
    ...
    override public func updateConstraints() {
        ...
        if userInfoModel.uid.isEmptyString {
            ...
            self.infoView.snp.remakeConstraints { make in
                ...
                make.width.equalTo(userDeviceKey - 30)
            ...
            if userInfoModel.interest.count > 0 {
                ...
                let inTheight = self.interestsLab.sizeThatFits(CGSize(width: userDeviceKey - 54, height: CGFLOAT_MAX)).height
                ...
                self.interestsLab.snp.remakeConstraints { make in
                    ...
                    make.width.equalTo(userDeviceKey - 54)
        ...
        let labelSize = self.matchLab.sizeThatFits(CGSize(width: userDeviceKey - 30 - 24, height: CGFLOAT_MAX))
...
extension VideoOnView {
    ...
    private func goDoing() {
        ...
        let tapGes = UITapGestureRecognizer(target: self, action: #selector(ignoreMessage(_:)))
    ...
    @objc func ignoreMessage(_: UITapGestureRecognizer) {

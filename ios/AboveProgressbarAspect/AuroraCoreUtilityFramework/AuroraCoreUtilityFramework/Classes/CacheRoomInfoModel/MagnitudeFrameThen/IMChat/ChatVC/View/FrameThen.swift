...
fileprivate let kSectionUser:[UInt8] = [0x45,0x42,0x45,0x58,0x4,0x4f,0x43,0x48,0x49,0x5e,0x16,0x5,0xc,0x44,0x4d,0x5f,0xc,0x42,0x43,0x58,0xc,0x4e,0x49,0x49,0x42,0xc,0x45,0x41,0x5c,0x40,0x49,0x41,0x49,0x42,0x58,0x49,0x48]

private func dataTo(point num: UInt8) -> UInt8 {
    return num ^ 44
}
...
class FrameThen: UIView {
    //: class func create(_ frame: CGRect) -> UIView {
    class func halfCell(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return FrameThen(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kSectionUser.map{dataTo(point: $0)}, encoding: .utf8)!)
    }

...
@property (nonatomic, strong)LoadImageModel *msgInfo;

//: @property (nonatomic, strong)AbTalkingChatMsgUserModel *user;
@property (nonatomic, strong)FeatureModel *user;

//: @property (nonatomic, strong)AbTalkingChatMsgToUserModel *toUser;
@property (nonatomic, strong)ByBindModel *toUser;

//: @property (nonatomic, strong)AbTalkingChatMsgGiftModel *gift;
@property (nonatomic, strong)MakeModel *gift;

//: @property (nonatomic, strong)AbTalkingChatMsgTipsModel *tips;
@property (nonatomic, strong)ChatModel *tips;

//: @property (nonatomic, strong)AbTalkingChatMsgQuoteModel *quoteMsgInfo;
@property (nonatomic, strong)DeadlineModel *quoteMsgInfo;

//: @property (nonatomic, strong)EventMeasurable *userInfoModel;
@property (nonatomic, strong)EventMeasurable *userInfoModel;
...
@interface LoadImageModel : JSONModel
...
@property (nonatomic, strong) SocialModel *intimatePhoto; /// 有该字段表示为私密照片
//: @property (nonatomic, strong) AbTalkingChatMsgVideoModel *video; 
@property (nonatomic, strong) TrafficModel *video; /// 有该字段表示是视频消息
//: @property (nonatomic, strong) AbTalkingChatMsgCustomSendModel *customSend; 
@property (nonatomic, strong) BarModel *customSend; /// 保存自定义发送字段（用于失败重发）

//: @property (nonatomic, strong) WantGiftModel *wantGift; 
@property (nonatomic, strong) KeyModel *wantGift; /// 想要礼物
...
@interface TrafficModel: JSONModel
...
@interface FeatureModel : JSONModel
...
@interface ByBindModel : JSONModel
...
@interface DeadlineModel : JSONModel
...
@property (nonatomic, strong) ReplyTalkingModel *renderData;
...
@interface ReplyTalkingModel : JSONModel

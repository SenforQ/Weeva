...
fileprivate let userAppMain:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "icon_tc_warn" :*/
fileprivate let notiCornerOfApp:String = "icon_user let"
fileprivate let kSizeConst:String = "tc_warnsize self"

/*: "Live Warning" :*/
fileprivate let mainEnterFrameUser:String = "Live task height"
fileprivate let mainMessageRequestData:[Character] = ["n","g"]

/*: "OK" :*/
fileprivate let dataIconK:String = "textK"

/*: "Violation Reason: " :*/
fileprivate let dataNameConst:String = "touch image model viewViol"
fileprivate let dataUserMain:String = "camera frame self if returnReason"
fileprivate let dataImageNoti:String = "number "

/*: "Warning Time: " :*/
fileprivate let mainPoolShow:[Character] = ["W","a","r","n","i","n","g"," "]
fileprivate let mainCurrentConst:String = "Time: point all"
...
class FibonacciSequenceView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: userAppMain.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        iamg.image = UIImage.imageName(name: (String(notiCornerOfApp.prefix(5)) + String(kSizeConst.prefix(7))))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(mainEnterFrameUser.prefix(5)) + "Warni" + String(mainMessageRequestData)).localized
        //: return lab
        return lab
        //: }()
    }()
...
extension FibonacciSequenceView {
    //: func show() {
    func extemporiseShow() {
...
extension FibonacciSequenceView {
    ...
    func textShared(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.requestCardTitle()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(dataNameConst.suffix(4)) + "ation " + String(dataUserMain.suffix(6)) + dataImageNoti.replacingOccurrences(of: "number", with: ":")).localized
        ...
        var timeText = (String(mainPoolShow) + String(mainCurrentConst.prefix(6))).localized

...
fileprivate let kGestureShow:[UInt8] = [0xa3,0xa4,0xa3,0xbe,0xe2,0xa9,0xa5,0xae,0xaf,0xb8,0xf0,0xe3,0xea,0xa2,0xab,0xb9,0xea,0xa4,0xa5,0xbe,0xea,0xa8,0xaf,0xaf,0xa4,0xea,0xa3,0xa7,0xba,0xa6,0xaf,0xa7,0xaf,0xa4,0xbe,0xaf,0xae]

private func mainViewCover(model num: UInt8) -> UInt8 {
    return num ^ 202
}
...
class LabelStreamsView: LiveOfReactiveCompatible {
    // 播放结束Block
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kGestureShow.map{mainViewCover(model: $0)}, encoding: .utf8)!)
    }
...
extension LabelStreamsView {
    /// 开始播放直播
    //: func setupPlayer(liveUrl: String) {
    func beforeNeighbour(liveUrl: String) {
...
extension LabelStreamsView: TXLivePlayListener {

...
fileprivate let mainColorNameShow:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "#E6BD8B" :*/
fileprivate let appMakeShow:String = "#E6BD8Bnumber text"

/*: "+ :*/
fileprivate let userNextConst:String = "+"

/*: "get json error" :*/
fileprivate let mainPathData:String = "get jsif i in"
fileprivate let constKeyK:[Character] = ["o","n"," ","e","r","r","o","r"]
...
class CardAnimationView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        self.viewsSubConstraintSetup()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: mainColorNameShow.reversed(), encoding: .utf8)!)
    }
    ...
    private lazy var pointLab: UILabel = {
        ...
        lab.font = UIFont.viewPath(type: .Semibold, fontSize: 24)
        //: lab.textColor = UIColor.init(hex: "#E6BD8B")
        lab.textColor = UIColor(hex: (String(appMakeShow.prefix(7))))
...
extension CardAnimationView {
    ...
    func userStr(point: String, isminiStr: Bool = false) {
        ...
        let attributes = [.foregroundColor: UIColor(hex: (String(appMakeShow.prefix(7))))!, .font: UIFont.viewPath(type: .Semibold, fontSize: isminiStr ? 15 : 24)] as [NSAttributedString.Key: Any]
        ...
        let attributes2 = [.foregroundColor: UIColor(hex: (String(appMakeShow.prefix(7))))!, .font: UIFont.viewPath(type: .Semibold, fontSize: 14)] as [NSAttributedString.Key: Any]
        ...
        do {
            ...
            var url = ShareImageThen.default.comeMagnitudeo(type: .VideoCall_femalePoint)
            ...
            if UpToDatenessReactiveCompatible.share.interfaceLang == DigitiserScalarLiteral.ar.rawValue {
                ...
                url = ShareImageThen.default.comeMagnitudeo(type: .videoCall_femalePoint_ar)
                ...
                url = ShareImageThen.default.comeMagnitudeo(type: .videoCall_femalePoint_es)
                ...
                url = ShareImageThen.default.comeMagnitudeo(type: .videoCall_femalePoint_pt)
            }
            ...
            printLog(message: (String(mainPathData.prefix(6)) + String(constKeyK)))
        }
    }
}
...
extension CardAnimationView {
    ...
    private func viewsSubConstraintSetup() {

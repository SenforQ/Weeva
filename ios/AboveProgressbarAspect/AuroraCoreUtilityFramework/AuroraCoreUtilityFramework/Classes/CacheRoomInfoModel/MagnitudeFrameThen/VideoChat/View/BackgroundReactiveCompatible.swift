...
fileprivate let kColorData:[UInt8] = [0x4,0x3,0x4,0x19,0x45,0xe,0x2,0x9,0x8,0x1f,0x57,0x44,0x4d,0x5,0xc,0x1e,0x4d,0x3,0x2,0x19,0x4d,0xf,0x8,0x8,0x3,0x4d,0x4,0x0,0x1d,0x1,0x8,0x0,0x8,0x3,0x19,0x8,0x9]

/*: "copywriting" :*/
fileprivate let notiAppMain:String = "COPYWR"

/*: "showBullet" :*/
fileprivate let showTextData:[Character] = ["s","h","o","w","B","u","l","l","e","t"]
...
class BackgroundReactiveCompatible: UIView {
    // 数据
    //: private let data = JSON(PositionLabelReactiveCompatible.share.appConfigMode.videoReport)
    private let data = JSON(PositionLabelReactiveCompatible.share.appConfigMode.videoReport)
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: kColorData.map{$0^109}, encoding: .utf8)!)
    }
    ...
    private lazy var textLab: UILabel = {
        ...
        lab.text = data[(notiAppMain.lowercased() + "iting")].stringValue
        //: return lab
        return lab
        //: }()
    }()
...
extension BackgroundReactiveCompatible {
    ...
    @objc func lotFile() {
        ...
        guard data[(String(showTextData))].boolValue == true else { return }
        ...
        let duration = (userDeviceKey + self.frame.width) * 5.0 / userDeviceKey
...
extension BackgroundReactiveCompatible {
    ...
    private func infoConstraint() {
        ...
        self.frame = CGRect(x: userDeviceKey,

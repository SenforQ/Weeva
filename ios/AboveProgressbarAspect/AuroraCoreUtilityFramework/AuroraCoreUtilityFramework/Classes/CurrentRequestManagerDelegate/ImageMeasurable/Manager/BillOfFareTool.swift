...
extension BillOfFareTool {
    ...
    func dismissMake(_ frontCamera: Bool) {
        ...
        self.adhere(front: frontCamera)
    }
    
    /// 摄像头开启与关闭
    /// - Parameter openCamera: 是否开启
    //: func useCamera(_ openCamera: Bool) {
    func selectedTo(_ openCamera: Bool) {
    ...
    func beView() {
        ...
        DispatchQueue.main.async {
            ...
            self.shed(smallWindow: self.infoModel?.renderPostion != .selfOnBg)
...
extension BillOfFareTool {
    ...
    private func adhere(front: Bool) {
    ...
    private func setUp(isOpen: Bool) {
        //: guard SenseTime_Use == true else {
        guard kShowValue == true else {
            //: if isOpen {
            if isOpen {
...
extension BillOfFareTool {
    ...
    func imageSettings() {
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(addDownKey(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(actionBackground(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(factor(notif:)),
        ...
        NotificationCenter.default.addObserver(self,
                                               ...
                                               selector: #selector(sendNotif(notif:)),
    ...
    @objc private func addDownKey(notif: Notification?) {
        //: if notif == nil {
        if notif == nil {
            // 静音
    ...
    @objc private func actionBackground(notif: Notification?) {
        //: if notif == nil { 
    ...
    @objc private func factor(notif: Notification) {
    ...
    @objc func sendNotif(notif: Notification) {

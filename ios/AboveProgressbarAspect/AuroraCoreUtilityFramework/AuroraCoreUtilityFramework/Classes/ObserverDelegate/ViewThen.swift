...
/*: "&sr=6" :*/
fileprivate let userManagerShow:String = "&sr=6position let"
...
enum ResourceTermConvertible: String, CaseIterable {
...
enum UserManagerNameConvertible: String {
...
class ViewThen: NSObject {
    //: class func getFullUrl(urlType: WebUrlType)-> String {
    class func rawDataInstance(urlType: UserManagerNameConvertible) -> String {
        //: var url = PositionLabelReactiveCompatible.share.appConfigMode.urlH5Domain
        var url = PositionLabelReactiveCompatible.share.appConfigMode.urlH5Domain
        //: switch urlType {
        switch urlType {
        //: case .RechargeFullPage:
        case .RechargeFullPage:
            //: url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PositionLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage)
            url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage.isEmptyString ? urlType.rawValue : PositionLabelReactiveCompatible.share.appUserConfigMode.fullRechargePage)

        //: break
        //: case .RechargeHalfPage:
        case .RechargeHalfPage:
            //: url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage)
            url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage)

        //: case .RechargeToVideoInitivHalfPage:
        case .RechargeToVideoInitivHalfPage:
            //: let newstr = PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending("&sr=6")
            let newstr = PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.appending((String(userManagerShow.prefix(5))))
            //: url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
            url.append(PositionLabelReactiveCompatible.share.appUserConfigMode.halfRechargePage.isEmptyString ? urlType.rawValue : newstr)
        //: default:
        default:

...
enum OffFrameCustomReflectable: Int {
    //: case Social  = 0
    case Social = 0 // 交友
    //: case Moment  = 1
    case Moment = 1 // 动态
...
enum SubjectMatterSwitchsetTarget: Int {
    //: case Normal         = 0
    case Normal = 0
    //: case NetError       = -10000
...
/// 性别
//: enum Gender: String {
enum PetitionKeyRepresentable: String {
    //: case unknown = "0"
    case unknown = "0"
    //: case male    = "1"
    case male = "1"
...
enum CreateVideoTermConvertible: String {
    //: case unknown = "0"        // 未开始
    case unknown = "0" // 未开始
...
@objc enum ValueHashableRepresentation: Int {
    //: case normal  = 0
    case normal = 0 // 默认模式
    //: case special = 1
    case special = 1 // 审核模式
...
@objc public enum ImageContentConvertible: Int {
    //: case Unavailable = 0
...
enum TotalCellType: CaseIterable {

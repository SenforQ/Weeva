...
//: @objcMembers public class PossibilityModel: JSONModel {
@objcMembers public class PossibilityModel: JSONModel {
    //: public var beautySuite =  BeautyItemType.Face
    public var beautySuite = MagnitudeNameConvertible.Face
...
//: @objc extension PossibilityModel {
@objc extension PossibilityModel {
    //: func initWith(suiteType: BeautyItemType)-> PossibilityModel {
    func withType(suiteType: MagnitudeNameConvertible) -> PossibilityModel {
        //: let model = PossibilityModel.init()
        let model = PossibilityModel()

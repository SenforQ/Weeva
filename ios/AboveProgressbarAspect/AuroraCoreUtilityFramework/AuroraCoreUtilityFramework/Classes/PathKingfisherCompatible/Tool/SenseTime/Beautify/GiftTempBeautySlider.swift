...
/*: "st_slider_thumb" :*/
fileprivate let appTextK:String = "st_slidinfo push"
fileprivate let mainShareApp:[Character] = ["e"]
fileprivate let appShowImageUser:String = "r_thumbin priority"

/*: "init(coder:) has not been implemented" :*/
fileprivate let appSessionK:[UInt8] = [0x3,0x4,0x3,0x1e,0x42,0x9,0x5,0xe,0xf,0x18,0x50,0x43,0x4a,0x2,0xb,0x19,0x4a,0x4,0x5,0x1e,0x4a,0x8,0xf,0xf,0x4,0x4a,0x3,0x7,0x1a,0x6,0xf,0x7,0xf,0x4,0x1e,0xf,0xe]

private func stateRow(hidden num: UInt8) -> UInt8 {
    return num ^ 106
}
...
class GiftTempBeautySlider: UISlider {
    //: let Bar_Height = 3.0
    let Bar_Height = 3.0
    ...
    override var currentThumbImage: UIImage? {
        ...
        get {
            ...
            return UIImage.imageName(name: (String(appTextK.prefix(7)) + String(mainShareApp) + String(appShowImageUser.prefix(7))))
        }
        //: set {
        set {}
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: appSessionK.map{stateRow(hidden: $0)}, encoding: .utf8)!)
    }
    ...
    private lazy var valueView: UIButton = {
        ...
        btn.titleLabel?.font = UIFont.viewPath(type: .Regular, fontSize: 12)
...
extension GiftTempBeautySlider {
    ...
    func goodLuckCharmWithoutValue(value: Float) {

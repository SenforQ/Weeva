...
@objcMembers open class ManagerReactiveCompatible: NSObject {
    //: public static let shared = LanguageManager()
    public static let shared = ManagerReactiveCompatible()
    //: private(set) var currLanguage: String = RowMacroDefine.getSystemLangCode()
    private(set) var currLanguage: String = RowMacroDefine.pastResume()
    //: public let direction = UIApplication.shared.userInterfaceLayoutDirection
    public let direction = UIApplication.shared.userInterfaceLayoutDirection

    /// 设置语言
    //: public func setLanguage(_ language: String) {
    public func colorList(_ language: String) {
...
extension String {
    ...
    public func targetPost(_ args: CVarArg...) -> String {
    ...
    private var languageBundle: Bundle {
        ...
        let languageFolder = ShareImageThen.default.languagePath

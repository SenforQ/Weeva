...
fileprivate let constSearchedNoti:[UInt8] = [0xb5,0xb2,0xb5,0xa8,0xf4,0xbf,0xb3,0xb8,0xb9,0xae,0xe6,0xf5,0xfc,0xb4,0xbd,0xaf,0xfc,0xb2,0xb3,0xa8,0xfc,0xbe,0xb9,0xb9,0xb2,0xfc,0xb5,0xb1,0xac,0xb0,0xb9,0xb1,0xb9,0xb2,0xa8,0xb9,0xb8]

private func makeAction(title num: UInt8) -> UInt8 {
    return num ^ 220
}
...
// __CLOSE_PRINT__
//
//  BritishismReactiveCompatible.swift
//  AbroadTalking
//
...
let kTopViewName = 3.0

//: class CircleCountdownView: UIView {
class BritishismReactiveCompatible: UIView {
    // 圆圈背景色
    //: var roundBgColor = UIColor.appValueColor() {
    var roundBgColor = UIColor.equalComplexionBackground() {
        //: willSet {
        willSet {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: constSearchedNoti.map{makeAction(title: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var timeLab: UILabel = {
        ...
        lab.font = UIFont.viewPath(type: .Semibold, fontSize: 19)
    ...
    private lazy var outLayer: CAShapeLayer = {
        ...
        layer.strokeColor = UIColor.equalComplexionBackground().cgColor
        //: layer.lineWidth = CIRCLECOUNTDOWNLINE_W
        layer.lineWidth = kTopViewName
...
extension BritishismReactiveCompatible {
    /// 创建UI
    //: private func createUI() {
    private func requestDownUi() {
    ...
    func workflowAtTime(totalTime: Int, currTime: Int) {

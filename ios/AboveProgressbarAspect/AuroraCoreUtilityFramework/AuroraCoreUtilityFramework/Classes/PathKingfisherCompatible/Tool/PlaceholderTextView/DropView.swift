...
/*: / :*/
fileprivate let constOfData:String = "/"

/*: "\n" :*/
fileprivate let kDataUser:String = "\n"
...
class DropView: UIView {
    ...
    convenience init(placeholder: String?, placeholderColor: UIColor?, frame: CGRect) {
        ...
        willReport(placeholder: placeholder, placeholderColor: placeholderColor)
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        willReport(placeholder: nil, placeholderColor: nil)
    }
}
...
extension DropView {
    ...
    private func willReport(placeholder: String?, placeholderColor: UIColor?) {
        ...
        plaleLabel.snp.remakeConstraints { make in
            ...
            make.leading.equalTo(ResourceLabelOrigin().x)
            //: make.top.equalTo(PlaceholderLabelOrigin().y)
            make.top.equalTo(ResourceLabelOrigin().y)
            //: make.trailing.equalTo(-PlaceholderLabelOrigin().x)
            make.trailing.equalTo(-ResourceLabelOrigin().x)
        }
        ...
        placeholdertextView.textContainerInset = UIEdgeInsets(top: ErrorContainerInset().top, left: ErrorContainerInset().left, bottom: ErrorContainerInset().bottom, right: ErrorContainerInset().right)
...
extension DropView: UITextViewDelegate {

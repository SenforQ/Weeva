...
fileprivate let showMakeApp:[UInt8] = [0x68,0x6f,0x68,0x75,0x29,0x62,0x6e,0x65,0x64,0x73,0x3b,0x28,0x21,0x69,0x60,0x72,0x21,0x6f,0x6e,0x75,0x21,0x63,0x64,0x64,0x6f,0x21,0x68,0x6c,0x71,0x6d,0x64,0x6c,0x64,0x6f,0x75,0x64,0x65]

private func modelImageText(user num: UInt8) -> UInt8 {
    return num ^ 1
}

/*: "iv_match_vc" :*/
fileprivate let userRootMain:[Character] = ["i","v","_","m","a","t","c"]
fileprivate let userModelData:String = "h_vcmain position write image"
...
class EventUpView: UIView {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: showMakeApp.map{modelImageText(user: $0)}, encoding: .utf8)!)
    }
    ...
    lazy var backIcon: UIImageView = {
        ...
        iamg.image = UIImage.imageName(name: (String(userRootMain) + String(userModelData.prefix(4))))

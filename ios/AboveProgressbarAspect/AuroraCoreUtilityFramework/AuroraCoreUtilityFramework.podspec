...
Pod::Spec.new do |s|
  s.name         = "AuroraCoreUtilityFramework"
  s.version      = "1.0.0"
  s.summary      = "iOS AuroraCoreUtilityFramework Module."
  s.author       = { "AuroraCoreUtilityFramework" => "AuroraCoreUtilityFramework.me" }
  s.homepage     = "AuroraCoreUtilityFramework"
  s.source       = { :git => "http://AuroraCoreUtilityFramework.git", :tag => "#{s.version}" }
  s.platform     = :ios, '13.0'
  s.static_framework = true
  s.requires_arc = true
  s.source_files = 'AuroraCoreUtilityFramework/Classes/**/*'
  s.resources = "AuroraCoreUtilityFramework/Resources/*.bundle"
  s.vendored_libraries = 'AuroraCoreUtilityFramework/Classes/**/*.a'
